...
## The Vienna Paintings
Just a brief look at these.

[Website to view the paintings at:](http://insidebruegel.net/#p/v=udroom&lan=en&a=1020)



[Children's Game Link](http://insidebruegel.net/#p/v=udroom&lan=en&a=1017)
...
```{r} 
url <- "https://s3.trueloveserver.com/arthum/childrens_play.JPG"
```  
![childrens_play](`r url`)
...
```{r} 
url <- "https://s3.trueloveserver.com/arthum/hunters_in_the_snow.JPG"
```  
![Hunters in the snow](`r url`)
